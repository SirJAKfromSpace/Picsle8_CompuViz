...
def get_loaders(path,split_perc=0.7,batch_size=32,num_workers=0):
    ...
    trainloader = D.DataLoader(train, batch_size=batch_size, shuffle=False, num_workers=num_workers)
    validloader = D.DataLoader(valid, batch_size=batch_size, shuffle=False, num_workers=num_workers)
